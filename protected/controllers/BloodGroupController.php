...
class BloodGroupController extends Controller
{
	...
	public function actionCreate()
	{
		...
		if(isset($_POST['BloodGroup']))
		{
			...
			if($model->save())
                Yii::app()->user->setFlash('success', 'Donor Details Saved successfully.');
	...
	public function actionUpdate($id)
	{
		...
		if(isset($_POST['BloodGroup']))
		{
			$model->attributes=$_POST['BloodGroup'];
			if($model->save())
                Yii::app()->user->setFlash('success', 'Donor Details Updated successfully.');
                $this->redirect(array('admin'));
		}
	...
	public function actionDelete($id)
	{
		if(Yii::app()->request->isPostRequest)
		{
            ...
            $response =  $model->updateAll(array('blood_group_ref_id' => null),'blood_group_ref_id=:x',array(':x' => $id));
