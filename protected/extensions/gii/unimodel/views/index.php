...
");
?>
<h1>Univariety Model Generator</h1>
This is inspired from the php5 popular ORMs <a target="_blank" href="http://www.propelorm.org">Propel</a> and <a target="_blank" href="http://doctrine-project.org/">Doctrine</a>
<br>
<p>This generators is created to solve the overwrite issue when updating a model. This is the replacement tool for
model generator. This generator will create 2 models (Base model and Model) files. Whenever the shema changes we only have to rebuild the BaseModel. All user defined code will be written in Model file so we do not have to worry about losing our
code whilre rebuilding the model and this also saves the developer time.
