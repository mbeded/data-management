...
<table cellpadding="12">
    ...
    <tr>
        ...
        <td><?php
            $age = array_combine($age,$age);
            echo $form->dropDownListRow($model, 'age', $age, array('class' => 'span3')); ?></td>
...
<?php
    if (!$model->isNewRecord && $model->is_technical==1) {
        $class = '';
    } else {
        $class = 'hidden';
    }
?>
    ...
    <table cellpadding="12">
        <tr>
            <td>
                <?php
                echo $form->fileFieldRow($model,'sewardar_picture',array('class'=>'span3','maxlength'=>45));
                if ($model->sewardar_picture!="") {
                    echo CHtml::image(Yii::app()->request->baseUrl."/attachments/sewadars_images/".$model->sewardar_picture, $model->sewardar_picture,array("width"=>100,"height"=>100));
                } else {
                    echo CHtml::image(Yii::app()->request->baseUrl . "/attachments/sewadars_images/no-pic.png", "no image uploaded", array("width" => 100, "height" => 100));
                }
                ?>
            </td>
