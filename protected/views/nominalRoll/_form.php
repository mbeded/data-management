...
<table cellpadding ='12'>
    <tr>
        ...
        <td>
            <?php $model->sewa_type = 'langer'; echo $form->textFieldRow($model,'sewa_type',array('class'=>'span2','maxlength'=>225)); ?>
        </td>
    ...
    <tr>
        ...
        <td colspan="2">
            ...
            echo $form->textFieldRow($model,'secretary_president_mobile_no',array('class'=>'span4')); ?>
    ...
    <tr>
        ...
        <td>
            <?php
            $model->sewa_sent = 'NO';
                echo $form->DropDownListRow($model,'sewa_sent',array('YES'=>'Yes','NO'=>'No'),array('class'=>'span2'))
            ?>
        </td>
        <td>
